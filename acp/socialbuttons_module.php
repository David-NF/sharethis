...
class socialbuttons_module
{
    ...
    public function main($id, $mode)
    {
		...
		$user->add_lang_ext('cece74/sharethis', 'common');		
		...
		if($request->is_set_post('action_purge_cache'))
		{
			...
			$cache_path = $phpbb_root_path . 'ext/cece74/sharethis/cache/';
	...
	private function button_style($selected)
	{
		...
		$path = $phpbb_extension_manager->get_extension_path('cece74/sharethis', true) . 'styles/all/template/';
		$return = '';
		for($i = 1; $i <= 10; $i++)
		{
